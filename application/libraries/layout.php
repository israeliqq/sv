...
/**
	 ...
	 * @var sting
	 */	
	public $title       = '..:: Panorama Conjunto ::..';	
    public $name       = 'Panorama Conjunto';	
	public $keywords    = 'Comando Conjunto Norte';	
	public $descripcion = 'Visualización Panomara para el Comando Conjunto Norte';
